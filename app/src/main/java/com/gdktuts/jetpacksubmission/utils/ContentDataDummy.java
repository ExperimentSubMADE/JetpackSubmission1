...
public class ContentDataDummy {

    public static ArrayList<MovieDataModel> movieDataDummies() {

        ArrayList<MovieDataModel> movieDataModels = new ArrayList<>();

        movieDataModels.add(new MovieDataModel(
                1,
                "A Star Is Born",
    ...
    public static ArrayList<TvShowDataModel> tvShowDataDummies() {

        ArrayList<TvShowDataModel> tvShowDataModels = new ArrayList<>();

        tvShowDataModels.add(new TvShowDataModel(
                1,
                "Doom Patrol",
        ...
        tvShowDataModels.add(new TvShowDataModel(
                ...
                61,
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/nv4nLXbDhcISPP8C1mgaxKU50KO.jpg",
                "https://image.tmdb.org/t/p/w600_and_h900_bestv2/nv4nLXbDhcISPP8C1mgaxKU50KO.jpg",
                "March 17, 2017",
        ...
        tvShowDataModels.add(new TvShowDataModel(
                ...
                73,
                "https://image.tmdb.org/t/p/original/reKs8y4mPwPkZG99ZpbKRhBPKsX.jpg",
